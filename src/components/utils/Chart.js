...
//     setloadStatus(false);
//     let url = HistoricalChart(props, days, "usd");
...
//           </p>
//         )}
//         {!props.loadedStatus && <div className="w-full h-16 mb-2" />}
//         {props.loadedStatus && (
...
//           </div>
//         )}
//         {!props.loadedStatus && <div className="w-full h-6 mb-2" />}
//         {props.loadedStatus && (
//           <div className="py-2 flex justify-between items-center">
...
//           </div>
//         )}
//         {!props.loadedStatus && <div className="w-full h-28 mb-2" />}
//         {props.loadedStatus && (
//           <div className="mb-6">
...
//       {!isLoaded && <div className="w-full h-10 mb-6" />}
//       {isLoaded && (
//         <div
...
//         </div>
//       )}
//       {!isLoaded && <div className="w-full h-[400px] p-2" />}
//       {isLoaded && (
