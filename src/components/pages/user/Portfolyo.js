...
function Portfolyo() {
    ...
    try {
      if (id && data) {
        ...
        if (data === "buy_total_crypto") {
          ...
          return <h1>{(dataCrypto.buy_total_crypto * price).toFixed(4)} $</h1>;
  ...
  // function portfolyoCalculate() {
  // if(coins && portfolyo){
  //   let total = 0;
  //   // eslint-disable-next-line array-callback-return
  //   portfolyo.map((item,index) => {
  //     console.log(item.buy_total_crypto);
  //     total += item.buy_total_crypto * coins.market_price.current_price.usd;
  //   });
  //   console.log(total);
      ...
      <div className="flex justify-center">
        <div className="mt-4 flex flex-col">
          ...
          <div className="flex  justify-center my-5">
            <div className="hover:shadow-xl border shadow-md p-5 rounded-lg font-bold">
              Hesap Bakiyesi : {wallet} $
            </div>
          </div>
