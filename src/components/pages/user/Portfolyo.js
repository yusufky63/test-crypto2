...
function Portfolyo() {
  ...
  return (
    <div className="portfolio-bg">
      {" "}
      <div className=" px-12  lg:px-8 pt-5 max-w-7xl mx-auto sm:px-6 relative">
        <h1 className="my-5  text-4xl text-red-500"> Geliştirme Aşamasında </h1>{" "}
        {
          <div className="w-full hover:shadow-xl border shadow-md p-5 rounded-lg font-bold flex justify-between">
            <span>
              {" "}
              Hesap Bakiyesi :{" "}
        ...
        {portfolyo.length > 0 ? (
          <>
            <div>
              <button className="border p-3 items-center px-5 text-sm sm:text-lg lg:text-lg xl:text-lg flex justify-between shadow-lg rounded-lg right-7 hover:bg-gray-100 drop-shadow-xl mt-5 hover:mb-2 transition-shadow absolute">
                <svg
